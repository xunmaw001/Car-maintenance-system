...
public class MendianxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,MendianxinxiEntity mendianxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,MendianxinxiEntity mendianxinxi, HttpServletRequest request){
        EntityWrapper<MendianxinxiEntity> ew = new EntityWrapper<MendianxinxiEntity>();
		PageUtils page = mendianxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, mendianxinxi), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R thumbsup(@PathVariable("id") String id,String type){
        MendianxinxiEntity mendianxinxi = mendianxinxiService.selectById(id);
        if(type.equals("1")) {
        	mendianxinxi.setThumbsupnum(mendianxinxi.getThumbsupnum()+1);
        } else {
        	mendianxinxi.setCrazilynum(mendianxinxi.getCrazilynum()+1);
        }
