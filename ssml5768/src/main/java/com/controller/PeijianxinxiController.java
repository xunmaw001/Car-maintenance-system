...
public class PeijianxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,PeijianxinxiEntity peijianxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,PeijianxinxiEntity peijianxinxi, HttpServletRequest request){
        EntityWrapper<PeijianxinxiEntity> ew = new EntityWrapper<PeijianxinxiEntity>();
		PageUtils page = peijianxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, peijianxinxi), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R thumbsup(@PathVariable("id") String id,String type){
        PeijianxinxiEntity peijianxinxi = peijianxinxiService.selectById(id);
        if(type.equals("1")) {
        	peijianxinxi.setThumbsupnum(peijianxinxi.getThumbsupnum()+1);
        } else {
        	peijianxinxi.setCrazilynum(peijianxinxi.getCrazilynum()+1);
        }
